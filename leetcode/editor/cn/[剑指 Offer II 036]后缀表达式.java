...
<div><div>Related Topics</div><div><li>栈</li><li>数组</li><li>数学</li></div></div><br><div><li>👍 2</li><li>👎 0</li></div>
*/
...
class Solution {
    public int evalRPN(String[] tokens) {
		...
		//Stack<String> oprations = new Stack<>();
		...
		for (String token : tokens) {
			if ("+".equals(token) || "-".equals(token) || "*".equals(token) || "/".equals(token)) {
				...
				int res = oprate(num1, num2, token);
				numbers.push(res);
			}
			else {
	...
	public int oprate(int num1, int num2, String token) {
